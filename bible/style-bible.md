...
- **שם ערוץ:** Pip's Meadow
- **שפה / גיל יעד:** אנגלית, גילאי 2–4
- **פלטת צבעים (HEX):**
  - טורקיז חתימה (צעיף Pip): `#2EC4B6`
  - חום-חולי חם (פרוות Pip / רקע-בית): `#C68958`
  - קרם בהיר (בטן Pip / רקע נייטרלי): `#F5E6D3`
  - צהוב-שמש (אקסנט לתפאורת "בית קבוע" / אלמנטים שמחים): `#FFD166`
  - לבן (פרטים קטנים, כוכבון על הצעיף): `#FFFFFF`
- **סגנון ויזואלי (פרומפט סגנון קבוע — סיומת קבועה לכל פרומפט, לפי `ai-visual-consistency`):**
  ```
